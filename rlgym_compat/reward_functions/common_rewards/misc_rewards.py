...
from rlgym_compat import math
from rlgym_compat.common_values import BLUE_TEAM, BLUE_GOAL_BACK, ORANGE_GOAL_BACK, ORANGE_TEAM, BALL_MAX_SPEED, \
    CAR_MAX_SPEED
from rlgym_compat.gamestates import GameState, PlayerData
