...
LARGE_BOOST_INDICES = [3, 4, 15, 18, 29, 30]
BOOST_RECHARGE_TIMES = [
    (
        BIG_PAD_RECHARGE_SECONDS
        if idx in LARGE_BOOST_INDICES
        else SMALL_PAD_RECHARGE_SECONDS
    )
    for idx in range(len(BOOST_LOCATIONS))
]
